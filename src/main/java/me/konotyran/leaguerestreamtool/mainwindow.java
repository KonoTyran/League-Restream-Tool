    ...
    private boolean WriteSchedule(String url) {
        try {
            ...
            for (Element row : rows) {
               ...
               dtm.addRow(new String[]{time,"<html>"+teams[0]+"<br>"+playerleft[0]+" "+playerleft[1]+"</html>","<html>"+teams[1]+"<br>"+playerright[0]+" "+playerright[1]+"</html>",channel,comms,tracker,notes});
